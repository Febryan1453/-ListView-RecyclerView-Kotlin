...
class BuahAdapter(val namaBuah : Array<String>, val  gambarBuah : Array<Int>, val musikBuah : Array<Int>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val mediaPlayer = MediaPlayer.create(holder.itemView.context, musikBuah[position])
            mediaPlayer.start()
        }
    }
